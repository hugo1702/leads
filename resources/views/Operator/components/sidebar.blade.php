<div id="sidebar"
    ...
    <nav class="mt-6">
        <a href="{{ route('operator.dashboard') }}" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-200 hover:text-gray-800">
        ...
        <a href="{{ route('operator.users.profile') }}" class="flex items-center px-6 py-3 text-gray-600 hover:bg-gray-200 hover:text-gray-800">
