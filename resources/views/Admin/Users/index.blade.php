        ...
        <div class="flex items-center justify-between ">
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                ...
                <form method="GET" action="{{ route('admin.users.index') }}">
                    <input type="hidden" name="inactivos" value="{{ $filtroInactivos ? 1 : '' }}">
                    <select name="role" onchange="this.form.submit()"
                        class="text-sm border-gray-300 rounded-md px-3 py-2 shadow focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <tbody class="bg-white divide-y divide-gray-200 text-left">
                    @forelse ($users as $user)
                        <tr>
                            ...
                            <td class="px-3 py-3 text-sm text-gray-900">{{ $user->role }}</td>
                            </td>
